    ...
    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in duration-300">
      ...
      <div className="border-b border-slate-200 dark:border-white/5 pb-6">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
          Configure a new event album and choose access visibility.
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 pt-2">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 py-3 text-sm font-semibold text-white transition hover:from-violet-500 hover:to-indigo-500 disabled:opacity-50 cursor-pointer shadow-lg shadow-violet-600/10 text-center animate-pulse-subtle"
            >
